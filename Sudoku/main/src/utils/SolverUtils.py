...
# C is matrix. Every row corresponds to an empty cell and has 12 integers. First 9 indicate possible numbers accepted in cell and 3 later indicate [row,col,box]
def ConstructC(A):
